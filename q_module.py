...
def main():
        ...
        nxt=input('3. Have your been energy deprived for the past the past 7 days?:')
        thrd=input("4.How was your sleep for the past 7 days: ")
        fur=input("5. How often have you felt sad in the past 7 days:")
