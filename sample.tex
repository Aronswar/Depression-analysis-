...
\title{Using AI and Social media to amalyse Depression}
\numberofauthors{2}
\author{
  \alignauthor Harun Gunasekaran\\
    \affaddr{University of Massachusetts-Lowell}\\
    \email{harun_gunasekaran@student.uml.edu}\\
  \alignauthor Lekan Osagi\\
    \affaddr{University of Massachusetts-Lowel}\\
    \email{lekan_osagiw@student.uml.edu}
}
